...
/*    @Override
    ...
    public static long comparator(int firstYear, int firstMonth, int firstDay,
                                  int secondYear, int secondMonth, int secondDay){

        String forFirstDate = firstYear + "-" + firstMonth + "-" + firstDay;
        String forSecondDate = secondYear + "-" + secondMonth + "-" + secondDay;

        Date firstDate = TransformationStrDate.transformation(forFirstDate);
        Date secondDate = TransformationStrDate.transformation(forSecondDate);
